...
-   **Include screenshots** which show you following the described steps and demonstrate the problem.
...
1.  Follow style guidelines (ESLint/Prettier).
2.  Use meaningful commit messages.
3.  Update documentation if you change functionality or add features.
4.  Ensure your code builds locally (`npm run build`).
